...
def heuns_method(f: Callable[..., float], x: float, y: float, start: float, end: float, n: int) -> List[Tuple[float, float]]:
    """
    Function to solve a first order differential equation using Heun's method.
