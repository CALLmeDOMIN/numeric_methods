from .nonlinear_equations import newtons_method, secant_method, find_roots
...
__all__ = ['newtons_method', 'secant_method', 'find_roots', 'eulers_method', 'heuns_method', 'midpoint_method', 'runge_kutta_method', 'trapezoidal_formula', 'simpson_formula', 'gauss_legendre_formula', 'gauss_legendre_formula_intervals', 'approximate_integral',  'lagrange_interpolation', 'natural_interpolation',
