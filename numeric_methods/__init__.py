...
__all__ = ['eulers_method', 'heuns_method', 'midpoint_method', 'runge_kutta_method', 'trapezoidal_formula', 'simpson_formula', 'gauss_legendre_formula', 'gauss_legendre_formula_intervals', 'approximate_integral',  'lagrange_interpolation', 'natural_interpolation',
