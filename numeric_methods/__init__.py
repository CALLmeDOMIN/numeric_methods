...
__all__ = ['trapezoidal_formula', 'simpson_formula', 'gauss_legendre_formula', 'gauss_legendre_formula_intervals', 'approximate_integral',  'lagrange_interpolation', 'natural_interpolation',
